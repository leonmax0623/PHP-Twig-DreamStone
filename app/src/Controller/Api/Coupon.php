...
use DS\Model\Coupon as CouponModel;
 ...
 */
final class Coupon extends ApiController
{
    /**
    ...
    public function __construct(\Slim\Container $c)
    {
        ...
        $this->model = new CouponModel($c->mongodb);
    }
    ...
    public function createAction(Request $request, Response $response, $args)
    {
        ...
        $this->logger->info("COUPON PARAMS:\n" . json_encode($d));
    ...
    public function updateAction(Request $request, Response $response, $args)
    {
        ...
        $coupon = $this->model->findById($args['id']);
